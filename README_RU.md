...
Справочник одиночных экономических экспериментов и переходов этапов кампании.
...
- **Age transition notes** — запланированный модуль; реализации нет.
- **Settlement economy comparisons** — запланированный модуль; реализации нет.
- **Ruleset test journal** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Age transition notes**.
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Sid Meier's Civilization VII, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Settlement economy comparisons

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Sid Meier's Civilization VII, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Ruleset test journal

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Sid Meier's Civilization VII, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Sid Meier's Civilization VII |
...
| Планируемый результат | Age transition notes |

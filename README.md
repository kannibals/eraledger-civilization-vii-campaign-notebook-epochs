...
<div align="center">
  <img src="./public/logo.svg" alt="EraLedger — Sid Meier&apos;s Civilization VII — Epochs" width="64" height="64">
  <h1>EraLedger — Sid Meier&apos;s Civilization VII — Epochs</h1>
</div>

An independent project specification for Sid Meier's Civilization VII, covering age transition notes, settlement economy comparisons, ruleset test journal.
...
<img src="./public/screenshots/desktop-main.svg" alt="Sid Meier&apos;s Civilization VII — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Sid Meier&apos;s Civilization VII — compact concept, not a screenshot" width="250">
<br>
...
- **Age transition notes** — planned module; not implemented.
- **Settlement economy comparisons** — planned module; not implemented.
- **Ruleset test journal** — planned module; not implemented.

The proposed workflow separates age transition notes from settlement economy comparisons, with ruleset test journal retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Age transition notes**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="EraLedger — Sid Meier&apos;s Civilization VII — Epochs — specification review workflow">
<br>
...
Define the input and expected outcome for module 1. Record the Sid Meier's Civilization VII version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Settlement economy comparisons

Define the input and expected outcome for module 2. Record the Sid Meier's Civilization VII version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Ruleset test journal

Define the input and expected outcome for module 3. Record the Sid Meier's Civilization VII version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Sid Meier's Civilization VII |
| Category | Offline game project |
| Input | Manual notes or user-authorized local exports |
| Planned output | Age transition notes |
